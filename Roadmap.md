...
We believe it is crucial for the policy community to develop clear proposals for translating its domain expertise into the debates surrounding AI technologies. Acting on the scale of geopolitics demands adherence to ethical standards in a highly operational context. Thhis connection - between ethics and operations - holds valuable insights for the debates on the ethical deployment of AI. 
